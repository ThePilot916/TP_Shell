...
{
       0,    20,    20,    26,    34,    35,    39,    40,    41,    42,
      43,    46,    54,    64,    75,    84,    87,    88
};
#endif
...
{
  "$end", "error", "$undefined", "GREAT", "GREATx2", "NEWLINE", "WORD",
  "GREATAMP", "AMP", "PIPE", "LESS", "$accept", "command_line",
  "io_modifier_list", "io_modifier", "pipe_list", "cmd_args", "arg_list",
...
{
       0,     3,    15,     0,     5,    12,    13,     1,     0,    17,
      14,    11,     0,     0,     0,    16,     0,     4,     0,     7,
       6,     0,     9,    10,     2,     8
};
...
{
      12,    13,     7,     8,    14,    15,    20,    16,    21,     1,
       2,    10,     2,    19,    22,    23,    24,     0,    25,     0,
       0,    11
};

static const yytype_int8 yycheck[] =
{
       3,     4,     0,     9,     7,     8,     6,    10,     8,     5,
       6,     6,     6,     6,     6,     6,     5,    -1,     6,    -1,
      -1,     8
};
...
{
       0,     5,     6,    12,    15,    16,    17,     0,     9,    13,
       6,    16,     3,     4,     7,     8,    10,    14,    18,     6,
       6,     8,     6,     6,     5,     6
};
